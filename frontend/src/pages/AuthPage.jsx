...
export default function AuthPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const endpoint = isLogin ? "http://127.0.0.1:8000/auth/signin" : "http://127.0.0.1:8000/auth/signup";
            ...
            const response = await fetch(endpoint, {
                method: "POST", headers: {
                    ...
                    first_name, last_name, username: formData.username, password: formData.password,
                }),
            });
